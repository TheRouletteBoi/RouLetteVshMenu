...
int stdc_EE303936(double x);                                                   // _Dsign()
static int _Dsign(double x) { return stdc_EE303936(x); }

double stdc_0F428F0F(double x);                                                // rint()
static double rint(double x) { return stdc_0F428F0F(x); }

int stdc_3AD203FA(double x);                                                   // lrint()
static int lrint(double x) { return stdc_3AD203FA(x); }

long int stdc_9558ED08(float x);                                               // lrintf()
static long int lrintf(float x) { return stdc_9558ED08(x); }

double stdc_21E6D304(double x);                                                // ceil()
static double ceil(double x) { return stdc_21E6D304(x); }

float stdc_BAF11866(float x);                                                  // ceilf()
static float ceilf(float x) { return stdc_BAF11866(x); }

double stdc_475D855B(double x);                                                // trunc()
static double trunc(double x) { return stdc_475D855B(x); }
...
static double round(double x) { return stdc_F3EC0258(x); }

float stdc_C984BF53(float x);                                                   // roundf()
static float roundf(float x) { return stdc_C984BF53(x); }

long int stdc_772F1E4D(double x);                                              // lround()
static long int lround(double x) { return stdc_772F1E4D(x); }

long int stdc_FBB4047A(float x);                                               // lroundf()
static long int lroundf(float x) { return stdc_FBB4047A(x); }

float stdc_7C2EAEB5(float x, float y);                                         // fminf()
static float fminf(float x, float y) { return stdc_7C2EAEB5(x, y); }

float stdc_895CDB49(float x, float y);                                         // fmaxf()
static float fmaxf(float x, float y) { return stdc_895CDB49(x, y); }

double stdc_A713F8CF(double x, double* intpart);                               // modf()
static double modf(double x, double* intpart) { return stdc_A713F8CF(x, intpart); }

double stdc_E769E5CF(double numer, double denom);                              // fmod()
static double fmod(double numer, double denom) { return stdc_E769E5CF(numer, denom); }

float stdc_9A81E583(float numer, float denom);                                 // fmodf()
static float fmodf(float numer, float denom) { return stdc_9A81E583(numer, denom); }
...
static float expf(float x) { return stdc_FCF08193(x); }

double stdc_7F381837(double x, int *_exp);                                      // frexp()
static double frexp(double x, int *_exp) { return stdc_7F381837(x, _exp); }

double stdc_38E69F09(double x, double y);                                      // pow()
static double pow(double x, double y) { return stdc_38E69F09(x, y); }

float stdc_4DDB926B(float x, float y);                                         // powf()
static float powf(float x, float y) { return stdc_4DDB926B(x, y); }

float stdc_00FDE072(float x, float y);                                         // f_powf()
static float f_powf(float x, float y) { return stdc_00FDE072(x, y); }
...
static double asin(double x) { return stdc_05EFC660(x); }

float stdc_411434BB(float x);                                                  // asinf()
static float asinf(float x) { return stdc_411434BB(x); }

float stdc_7AB679DA(float x);                                                  // f_cosf()
static float f_cosf(float x) { return stdc_7AB679DA(x); }

double stdc_1313A420(double x);                                                // acos()
static double acos(double x) { return stdc_1313A420(x); }

float stdc_DECE76A6(float x);                                                  // acosf()
static float acosf(float x) { return stdc_DECE76A6(x); }

float stdc_705D9E24(float x);                                                  // f_acosf()
static float f_acosf(float x) { return stdc_705D9E24(x); }

double stdc_D50277AD(double x);                                                // tan()
static double tan(double x) { return stdc_D50277AD(x); }

float stdc_9379E36E(float x);                                                  // tanf()
static float tanf(float x) { return stdc_9379E36E(x); }

double stdc_7F579E03(double x);                                                // atan()
static double atan(double x) { return stdc_7F579E03(x); }

float stdc_3C057FBD(float x);                                                  // atanf()
static float atanf(float x) { return stdc_3C057FBD(x); }

double stdc_31DB8C89(double y, double x);                                      // atan2()
static double atan2(double y, double x) { return stdc_31DB8C89(y, x); }

float stdc_FB932A56(float y, float x);                                         // atan2f()
static float atan2f(float y, float x) { return stdc_FB932A56(y, x); }

float stdc_ABDCCC7A(float y, float x);                                         // f_atan2f()
static float f_atan2f(float y, float x) { return stdc_ABDCCC7A(y, x); }

float stdc_B7696143(float from, float to);                                     // nextafterf()
static float nextafterf(float from, float to) { return stdc_B7696143(from, to); }

int* stdc_44115DD0();														   // _Geterrno()
//static int errno() { return (*stdc_44115DD0()); }

void stdc_8B439438(FILE *stream);                                              // clearerr()
static void clearerr(FILE *stream) { stdc_8B439438(stream); }

void stdc_692B497F(const char *str);                                           // perror()
static void perror(const char *str) { stdc_692B497F(str); }
...
static uint64_t _Stoull(const char *a, char **b, int x) { return stdc_D417EEB5(a, b, x); }

long stdc_116CDA13(const wchar_t *restrict_nptr, wchar_t **restrict_endptr, int base);  // wcstol
static long wcstol(const wchar_t *restrict_nptr, wchar_t **restrict_endptr, int base) { return stdc_116CDA13(restrict_nptr, restrict_endptr, base); }

long long int stdc_A30D4797(const wchar_t* str, wchar_t** endptr, int base);   // wcstoll()
static long long int wcstoll(const wchar_t* str, wchar_t** endptr, int base) { return stdc_A30D4797(str, endptr, base); }
...
static int sprintf(char* str, const char* format, ...)
{
    ...
    r = vsh::vsprintf(str, format, args);
    va_end(args);
    return r;
}
...
static int snprintf(char* str, size_t size, const char* format, ...)
{
    ...
    va_list args;
    va_start(args, format);
    r = vsh::vsnprintf(str, size, format, args);
    va_end(args);
    return r;
}

static char vaBuffer[0x400]{0};
static const char* va(const char* format, ...)
{
    va_list args;
    va_start(args, format);
    vsh::vsnprintf(vaBuffer, 0x400, format, args);
    va_end(args);
    return vaBuffer;
}
...
static int swprintf(wchar_t* s, size_t n, const wchar_t* fmt, ...)
{
    ...
    va_start(ap, fmt);
    ret = vsh::vswprintf(s, n, fmt, ap);
    va_end(ap);

    return (ret);
}

static wchar_t wvaBuffer[0x400]{0};
static const wchar_t* wva(const wchar_t* format, ...)
{
    va_list args;
    va_start(args, format);
    vsh::vswprintf(wvaBuffer, 0x400, format, args);
    va_end(args);
    return wvaBuffer;
}
...
static int putchar(int c) { return stdc_2677568C(c); }

int stdc_79819DBF(int c, FILE *stream);                                        // fputc()
static int fputc(int c, FILE *stream) { return stdc_79819DBF(c, stream); }
...
static int fsync(int fd) { return stdc_3BD9CE0A(fd); }
...
static int fileno(FILE *stream) { return stdc_D360DCB4(stream); }
...
static off_t lseek(int fd, off_t offset, int whence) { return stdc_AEC7C970(fd, offset, whence); }
...
static void qsort(void *base, size_t num, size_t size, int(*compar)(const void*, const void*)) { stdc_A9F68EFF(base, num, size, compar); }

void *stdc_5E7888F0(const void *key, const void *base, size_t nitems, size_t size, int(*compar)(const void *, const void *));  // bsearch()
static void *bsearch(const void *key, const void *base, size_t nitems, size_t size, int(*compar)(const void *, const void *)) { return stdc_5E7888F0(key, base, nitems, size, compar); }
...
static int setvbuf(FILE *restrict_stream, char *restrict_buf, int type, size_t size) { return stdc_703EC767(restrict_stream, restrict_buf, type, size); }

// stdc_7670FF88  // ?

double stdc_8ECAE294(double x, double y);                                      // nextafter()
static double nextafter(double x, double y) { return stdc_8ECAE294(x, y); }
