...
extern "C" sys_prx_id_t sysPrxForUser_0341BB97(void* addr);                   // sys_prx_get_module_id_by_address()
#define sys_prx_get_module_id_by_address sysPrxForUser_0341BB97

extern "C" int sysPrxForUser_04E83D2C(const char *str1,                       // _sys_strncmp()
                                  const char *str2,
                                  size_t num);
#define sys_strncmp sysPrxForUser_04E83D2C

extern "C" char *sysPrxForUser_052D29A6(char *dest,                           // _sys_strcat()
                                    const char *src);
#define sys_strcat sysPrxForUser_052D29A6

extern "C" void *sysPrxForUser_05C65656(sys_mempool_t mempool);               // sys_mempool_try_allocate_block()
#define sys_mempool_try_allocate_block sysPrxForUser_05C65656

extern "C" int sysPrxForUser_0618936B(char *s,                                // _sys_vsnprintf()
                                  size_t n,
                                  const char *fmt,
                                  va_list arg);
#define sys_vsnprintf sysPrxForUser_0618936B

extern "C" int sysPrxForUser_06574237(char *str,                              // _sys_snprintf()
                                  size_t size,
                                  const char *fmt, ...);
...
extern "C" int sysPrxForUser_1573DC3F(sys_lwmutex_t *lwmutex,                 // sys_lwmutex_lock()
                                  usecond_t timeout);
#define sys_lwmutex_lock sysPrxForUser_1573DC3F

extern "C" char *sysPrxForUser_191F0C4A(const char *s,                        // _sys_strrchr()
                                    int c);
...
extern "C" int sysPrxForUser_1BC200F4(sys_lwmutex_t *lwmutex);                // sys_lwmutex_unlock()
#define sys_lwmutex_unlock sysPrxForUser_1BC200F4

extern "C" int sysPrxForUser_1C9A942C(sys_lwcond_t *lwcond);                  // sys_lwcond_destroy()
#define sys_lwcond_destroy sysPrxForUser_1C9A942C

extern "C" int sysPrxForUser_1CA525A2(const char *s1,                         // _sys_strncasecmp()
                                  const char *s2, size_t n);
#define sys_strncasecmp sysPrxForUser_1CA525A2

// sysPrxForUser_1ED454CE  // sys_spu_elf_get_information

extern "C" int sysPrxForUser_24A1EA07(sys_ppu_thread_t *thread_id,            // sys_ppu_thread_create()
                                  void (*entry)(uint64_t),
                                  uint64_t arg,
                                  int prio,
                                  size_t stacksize,
...
extern "C" uint64_t sysPrxForUser_25596F51(sys_mempool_t mempool);            // sys_mempool_get_count()
#define sys_mempool_get_count sysPrxForUser_25596F51

extern "C" sys_prx_id_t sysPrxForUser_26090058(const char* path,              // sys_prx_load_module()
                                           sys_prx_flags_t flags,
                                           sys_prx_load_module_option_t *pOpt);
#define sys_prx_load_module sysPrxForUser_26090058

extern "C" void *sysPrxForUser_27427742(void *str1,                           // _sys_memmove()
                                    const void *str2,
                                    size_t n);
#define sys_memmove sysPrxForUser_27427742

extern "C" int sysPrxForUser_2A6D9D51(sys_lwcond_t *lwcond,                   // sys_lwcond_wait()
                                  usecond_t timeout);
#define sys_lwcond_wait sysPrxForUser_2A6D9D51

// sysPrxForUser_2C847572  // _sys_process_atexitspawn

extern "C" size_t sysPrxForUser_2D36462B(const char *str);                    // _sys_strlen()
#define sys_strlen sysPrxForUser_2D36462B

// sysPrxForUser_2F256B29  // ? sys_rsxaudio_import_shared_memory (2 params)

extern "C" int sysPrxForUser_2F85C0EF(sys_lwmutex_t *lwmutex,                 // sys_lwmutex_create()
                                  sys_lwmutex_attribute_t *attr);
#define sys_lwmutex_create sysPrxForUser_2F85C0EF

// sysPrxForUser_3172759D  // sys_game_get_temperature

extern "C" void *sysPrxForUser_318F17E1(size_t alignment,                     // _sys_memalign()
                                    size_t size);
#define sys_memalign sysPrxForUser_318F17E1

extern "C" int sysPrxForUser_350D454E(sys_ppu_thread_t *thread_id);           // sys_ppu_thread_get_id()
...
extern "C" void *sysPrxForUser_3BD53C7B(void *ptr,                            // sys_memchr()
                                    int value,
                                    size_t num);
...
extern "C" int sysPrxForUser_409AD939(sys_memory_t mem_id);                   // sys_mmapper_free_memory()
#define sys_mmapper_free_memory sysPrxForUser_409AD939

// sysPrxForUser_4232B0DB  // ?

extern "C" int sysPrxForUser_42B23552(void* library);                         // sys_prx_register_library()
#define sys_prx_register_library sysPrxForUser_42B23552

// sysPrxForUser_44265C08  // _sys_heap_memalign

extern "C" int sysPrxForUser_459B4393(const char *str1,                       // sys_strcmp()
                                  const char *str2);
...
extern "C" int sysPrxForUser_4643BA6E(sys_addr_t start_addr,                  // sys_mmapper_unmap_memory()
                                  sys_memory_t *mem_id);
#define sys_mmapper_unmap_memory sysPrxForUser_4643BA6E

extern "C" int sysPrxForUser_4A071D98(sys_interrupt_thread_handle_t ih);      // sys_interrupt_thread_disestablish()
#define sys_interrupt_thread_disestablish sysPrxForUser_4A071D98

extern "C" int sysPrxForUser_4B2F301A(int c);                                 // sys_tolower()
...
extern "C" int sysPrxForUser_4F7172C9(const void *p);                         // sys_process_is_stack()
#define sys_process_is_stack sysPrxForUser_4F7172C9

extern "C" void sysPrxForUser_5267CB35(int *lock);                            // sys_spinlock_unlock()
#define sys_spinlock_unlock sysPrxForUser_5267CB35

extern "C" int sysPrxForUser_52AADADF(sys_lwcond_t *lwcond,                   // sys_lwcond_signal_to()
...
extern "C" int sysPrxForUser_608212FC(sys_mempool_t mempool,                  // sys_mempool_free_block()
                                  void *block);
...
extern "C" void *sysPrxForUser_68B9B011(void *str,                            // sys_memset()
                                    int c,
                                    size_t n);
#define sys_memset sysPrxForUser_68B9B011

extern "C" void *sysPrxForUser_6BF66EA7(void *dest,                           // sys_memcpy()
                                    const void *src,
                                    size_t num); 
...
extern "C" int sysPrxForUser_70258515(size_t size,                            // sys_mmapper_allocate_memory_from_container()
                                  sys_memory_container_t container,
                                  uint64_t flags,
                                  sys_memory_t *mem_id);
#define sys_mmapper_allocate_memory_from_container sysPrxForUser_70258515

extern "C" int sysPrxForUser_71A8472A(void* addr,                             // sys_get_random_number()
                                  uint64_t size);
#define sys_get_random_number sysPrxForUser_71A8472A

extern "C" int sysPrxForUser_722A0254(int *lock);                             // sys_spinlock_trylock()
#define sys_spinlock_trylock sysPrxForUser_722A0254

// sysPrxForUser_728FD7C3  // ?

extern "C" sys_prx_id_t sysPrxForUser_74311398(void);                         // sys_prx_get_my_module_id()
#define sys_prx_get_my_module_id sysPrxForUser_74311398

// sysPrxForUser_744680A2  // sys_initialize_tls

extern "C" char *sysPrxForUser_7498887B(char *str,                            // sys_strchr()
                                    int c);
#define sys_strchr sysPrxForUser_7498887B

// sysPrxForUser_750DD5CD  // ?

extern "C" int sysPrxForUser_791B9219(char *str,                              // sys_vsprintf() 
                                  const char *format,
                                  va_list arg);
...
extern "C" int sysPrxForUser_80FB0C19(sys_prx_id_t id,                        // sys_prx_stop_module()
                                  size_t args,
                                  void *argp,
                                  int *modres,
                                  sys_prx_flags_t flags,
...
extern "C" system_time_t sysPrxForUser_8461E528(void);                        // sys_time_get_system_time()
#define sys_time_get_system_time sysPrxForUser_8461E528

extern "C" int sysPrxForUser_84BB6774(sys_prx_id_t id,                        // sys_prx_get_module_info()
                                  sys_prx_flags_t flags,
...
extern "C" int sysPrxForUser_893305FA(sys_raw_spu_t id,                       // sys_raw_spu_load()
                                  const char *path,
                                  uint32_t *entry);
...
extern "C" CDECL_BEGIN void sysPrxForUser_8C2BB498(int *lock);                // sys_spinlock_initialize()
...
extern "C" char *sysPrxForUser_996F7CF8(char *dest,                           // sys_strncat()
                                    const char *src,
                                    size_t n);
#define sys_strncat sysPrxForUser_996F7CF8

extern "C" char *sysPrxForUser_99C88692(char *dest,                           // sys_strcpy()
                                    const char *src);
...
extern "C" void sysPrxForUser_9D3C0F81(sys_mempool_t mempool);                // sys_mempool_destroy()
#define sys_mempool_destroy sysPrxForUser_9D3C0F81

// sysPrxForUser_9E0623B5  // sys_game_watchdog_start

extern "C" int sysPrxForUser_9F04F7AF(const char *fmt, ...);                  // sys_printf()
#define sys_printf sysPrxForUser_9F04F7AF

extern "C" int sysPrxForUser_9F18429D(sys_prx_id_t id,                        // sys_prx_start_module()
                                  size_t args,
                                  void *argp,
                                  int *modres,
                                  sys_prx_flags_t flags,
...
extern "C" void *sysPrxForUser_A146A143(sys_mempool_t mempool);               // sys_mempool_allocate_block()
#define sys_mempool_allocate_block sysPrxForUser_A146A143

extern "C" int sysPrxForUser_A1F9EAFE(char *str,                              // sys_sprintf()
                                  const char *fmt, ...);
#define sys_sprintf sysPrxForUser_A1F9EAFE

extern "C" void sysPrxForUser_A285139D(int *lock);                            // sys_spinlock_lock()
#define sys_spinlock_lock sysPrxForUser_A285139D

// sysPrxForUser_A2C7BA64  // sys_prx_exitspawn_with_level

extern "C" sys_prx_id_t sysPrxForUser_A330AD84(int fd,                        // sys_prx_load_module_on_memcontainer_by_fd()
                                           off64_t offset,
...
extern "C" void sysPrxForUser_A3E3BE68(int *once_ctrl,                        // sys_ppu_thread_once()
                                   void (*init)(void));
#define sys_ppu_thread_once sysPrxForUser_A3E3BE68

extern "C" int sysPrxForUser_A5D06BF0(sys_prx_flags_t flags,                  // sys_prx_get_module_list()
...
extern "C" sys_prx_id_t sysPrxForUser_AA6D9BFF(const char* path,              // sys_prx_load_module_on_memcontainer()
                                           sys_memory_container_t mem_container,
                                           sys_prx_flags_t flags,
                                           sys_prx_load_module_option_t *pOpt);
...
extern "C" int sysPrxForUser_AEB78725(sys_lwmutex_t *lwmutex);                // sys_lwmutex_trylock()
#define sys_lwmutex_trylock sysPrxForUser_AEB78725

// sysPrxForUser_AEDE4B03  // _sys_heap_delete_heap

extern "C" void sysPrxForUser_AFF080A4(uint64_t val);                         // sys_ppu_thread_exit()
#define sys_ppu_thread_exit sysPrxForUser_AFF080A4

// sysPrxForUser_B1BD7A61  // sys_rsxaudio_close_connection(1 param)

extern "C" int sysPrxForUser_B257540B(uint64_t size,                          // sys_mmapper_allocate_memory()
                                  uint64_t flags,
                                  sys_memory_t *mem_id);
...
extern "C" int sysPrxForUser_B995662E(sys_raw_spu_t id,                       // sys_raw_spu_image_load()
                                  sys_spu_image_t *img);
...
extern "C" void *sysPrxForUser_BDB18F83(size_t size);                         // sys_malloc()
#define sys_malloc sysPrxForUser_BDB18F83

// sysPrxForUser_BF8EE5BB  // ret 0x80010003

extern "C" int sysPrxForUser_C3476D0C(sys_lwmutex_t *lwmutex);                // sys_lwmutex_destroy()
#define sys_lwmutex_destroy sysPrxForUser_C3476D0C

extern "C" void sysPrxForUser_C4FD6121(void *base,                            // sys_qsort()
                                   size_t num,
                                   size_t size,
...
extern "C" int sysPrxForUser_CA9A60BF(sys_mempool_t *mempool,                 // sys_mempool_create()
                                  void *chunk, 
...
extern "C" int sysPrxForUser_D0EA47A7(void* library);                         // sys_prx_unregister_library()
...
extern "C" char *sysPrxForUser_D3039D4D(char *dest,                           // sys_strncpy()  
                                    const char *src,
                                    size_t num);
...
extern "C" int sysPrxForUser_DA0EB71A(sys_lwcond_t *lwcond,                   // sys_lwcond_create()
...
extern "C" int sysPrxForUser_DC578057(sys_addr_t start_addr,                  // sys_mmapper_map_memory()
                                  sys_memory_t mem_id,
                                  uint64_t flags);
...
extern "C" sys_prx_id_t sysPrxForUser_E0998DBF(const char* name,              // sys_prx_get_module_id_by_name()
                                           sys_prx_flags_t flags,
                                           sys_prx_get_module_id_by_name_option_t *pOpt);
#define sys_prx_get_module_id_by_name sysPrxForUser_E0998DBF

extern "C" int sysPrxForUser_E0DA8EFD(sys_spu_image_t *img);                  // sys_spu_image_close()
#define sys_spu_image_close sysPrxForUser_E0DA8EFD

// sysPrxForUser_E66BAC36  // console_putc

extern "C" void sysPrxForUser_E6F2C1E7(int status);                           // sys_process_exit()
#define sys_process_exit sysPrxForUser_E6F2C1E7

extern "C" int32_t sysPrxForUser_E75C40F2(void *x);  // ?
...
extern "C" int sysPrxForUser_E9A1BD84(sys_lwcond_t *lwcond);                  // sys_lwcond_signal_all()
#define sys_lwcond_signal_all sysPrxForUser_E9A1BD84

extern "C" int sysPrxForUser_EBE5F72F(sys_spu_image_t *img,                   // sys_spu_image_import()
                                  const void *src,
                                  uint32_t type);
...
extern "C" int sysPrxForUser_EEF75113(int c);                                 // sys_toupper()
#define sys_toupper sysPrxForUser_EEF75113

extern "C" sys_prx_id_t sysPrxForUser_EF68C17C(int fd,                        // sys_prx_load_module_by_fd()
                                           off64_t offset,
                                           sys_prx_flags_t flags,
                                           sys_prx_load_module_option_t *pOpt);
#define sys_prx_load_module_by_fd sysPrxForUser_EF68C17C

extern "C" int sysPrxForUser_EF87A695(sys_lwcond_t *lwcond);                  // sys_lwcond_signal()
#define sys_lwcond_signal sysPrxForUser_EF87A695

extern "C" int sysPrxForUser_F0AECE0D(sys_prx_id_t id,                        // sys_prx_unload_module()
                                  sys_prx_flags_t flags,
...
extern "C" void sysPrxForUser_F7F7FB20(void *ptr);                            // sys_free()
#define sys_free sysPrxForUser_F7F7FB20

// sysPrxForUser_F82CF400  // ?
// sysPrxForUser_F923DADA  // ?

extern "C" int sysPrxForUser_FA7F693D(const char *format,                     // sys_vprintf()
                                  va_list arg);
#define sys_vprintf sysPrxForUser_FA7F693D

extern "C" int sysPrxForUser_FB5DB080(const void *ptr1,                       // sys_memcmp()
                                  const void *ptr2,
                                  size_t num);
...
//extern "C" void sysPrxForUser_FECC05B6(uint64_t);  // SYS_TIMEBASE_GET
