...
namespace vshnet
{
    ...
    int vshnet_59106229(const char* url);  // overrides regular update.txt url
    static int SetUpdateUrl(const char* url) { return vshnet_59106229(url); }
    ...
    // vshnet_5E9FDA92  // ?
    // vshnet_5EA49E2A  // ?
    int vshnet_5EE098BC(int, void*, int); // used for getting klicensee struct
    // vshnet_5EE81C09  // ?
    // vshnet_5EF49155  // ?
    // vshnet_5F2D9EF3  // ?
    // vshnet_5F4B48FA  // ?
    ...
    int vshnet_731E546F(const char *);  // prints Firmware version ("%02d.%02d) 	int vshnet_731E546F(out: const char*)
