...
extern "C" void *allocator_6137D196(size_t alignment, size_t size);  // memalign()
#define memalign allocator_6137D196

// allocator_679E8CAF  // ?
// allocator_6997B837  // ?

extern "C" void *allocator_759E0635(size_t size);  // malloc()
#define malloc allocator_759E0635

extern "C" void allocator_77A602DD(void *ptr);  // free()
...
extern "C" void *allocator_A72A7595(size_t nitems, size_t size);  // calloc()
...
extern "C" void *allocator_F7A14A22(void *ptr, size_t size);  // realloc()
#define _realloc allocator_F7A14A22
